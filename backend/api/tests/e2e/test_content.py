...
class TestCategoryCrud:
    ...
    async def test_category_lifecycle(
        ...
        create_resp = await superuser_client.post(
            "/api/admin/config/web-settings/categories/list/create",
            json={
        ...
        update_resp = await superuser_client.post(
            "/api/admin/config/web-settings/categories/list/detail/edit",
        ...
        delete_resp = await superuser_client.post(
            "/api/admin/config/web-settings/categories/list/detail/delete",
...
class TestArticleCrud:
    ...
    async def test_article_lifecycle(
        ...
        try:
            # 2. 创建文章
            create_resp = await superuser_client.post(
                "/api/admin/config/web-settings/articles/list/create",
                json={
            ...
            # 4. 更新文章标题
            update_resp = await superuser_client.post(
                "/api/admin/config/web-settings/articles/list/detail/edit",
                json={
            ...
            del_resp = await superuser_client.post(
                "/api/admin/config/web-settings/articles/list/detail/delete",
...
class TestAdminArticleList:
    ...
    async def test_list_articles(self, superuser_client):
        ...
        resp = await superuser_client.get(
            "/api/admin/config/web-settings/articles/list"
        )
        assert resp.status_code == 200
        data = resp.json()
        assert "items" in data
...
class TestAdminContentCrud:
    ...
    async def test_admin_content_lifecycle(
        ...
        cat_list_resp = await superuser_client.get(
            "/api/admin/config/web-settings/categories/list"
        )
