...
from api.portal.user.schemas import PasswordChange, PhoneChange
...
@pytest.mark.asyncio
@patch("api.portal.user.service.decrypt_password", return_value="newpass123")
@patch(AUTH_REPO)
@patch(USER_REPO)
async def test_change_password_success(
    ...
    with patch("api.portal.user.service.hash_password", return_value="new_hash"):
