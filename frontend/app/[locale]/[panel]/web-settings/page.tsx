...
export default function WebSettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      {/* 页面预览 tab */}
      {activeTab === 'preview' && (
        <div className="isolate flex h-[calc(100vh-10rem)] flex-col overflow-hidden rounded-lg border bg-white shadow-sm [&_a]:pointer-events-none [&_.group]:pointer-events-auto">
          {/* 模拟浏览器标签栏 */}
