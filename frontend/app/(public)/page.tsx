    ...
    <>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {services.map((service) => (
              ...
              >
                ...
                <h4 className="mt-4 text-lg font-bold group-hover:text-primary transition-colors">
                  {service.title}
                </h4>
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="rounded-lg border bg-white p-6 transition-colors duration-200 hover:border-primary"
              >
                <div className="text-xs text-muted-foreground">
                  2026-04-07
                </div>
                <h4 className="mt-2 font-bold hover:text-primary transition-colors cursor-pointer">
                  文章标题占位 {i}
                </h4>
      ...
      <section className="bg-primary py-16 text-primary-foreground">
        <div className="mx-auto max-w-7xl px-4 text-center">
          ...
          <Link
            href="/contact"
            className="mt-8 inline-block rounded-lg bg-white px-8 py-3 font-medium text-primary transition-transform hover:scale-105"
          >
            立即咨询
          </Link>
        </div>
