...
export function PdfToolbar({
  ...
  return (
    <div className="sticky bottom-4 z-30 mx-auto flex w-fit items-center gap-1 rounded-full bg-background/90 px-2 py-1 shadow-lg ring-1 ring-foreground/10 backdrop-blur">
      {hasOutline && (
        <Button
          variant="ghost"
          size="sm"
