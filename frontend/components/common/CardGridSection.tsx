...
import { Clock, CheckCircle2, Home, Bus, UtensilsCrossed, Palette, MapPin, Languages } from "lucide-react"

const LIFE_ICONS: Record<string, typeof Home> = { Home, Bus, UtensilsCrossed, Palette }
...
function renderBuiltinCard(card: any, i: number, type: string): ReactNode {
  switch (type) {
    ...
    case "guide": {
      const Icon = LIFE_ICONS[card.icon] || Home
      return (
        <div key={i} className="rounded-lg border bg-white p-6 text-center">
