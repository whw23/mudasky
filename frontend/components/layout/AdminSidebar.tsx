...
const MENU_KEYS: MenuItem[] = [
  ...
  { key: "universityManagement", href: "/admin/universities", icon: GraduationCap, permissions: ["admin/web-settings/universities/*"] },
  { key: "caseManagement", href: "/admin/cases", icon: Trophy, permissions: ["admin/web-settings/cases/*"] },
