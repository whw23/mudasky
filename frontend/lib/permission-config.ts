...
const ADMIN_PAGES: PageConfig[] = [
  ...
  { key: "universityManagement", href: "/admin/universities", apiPrefix: "admin/web-settings/universities" },
  { key: "caseManagement", href: "/admin/cases", apiPrefix: "admin/web-settings/cases" },
